...
pub struct SessionConfiguredEvent {
    ...
    /// Path where the rollout will be stored. Can be `None` for ephemeral threads. For fresh
    /// persistent threads, this path may be reported before the rollout file has been
